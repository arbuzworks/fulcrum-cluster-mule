 ...
 */
public class FulcrumClusterObjectStore<T extends Serializable>
        implements ListableObjectStore<T>, PartitionableObjectStore<T>, MuleContextAware {

    private static final Log LOGGER = LogFactory.getLog(FulcrumClusterObjectStore.class);
    ...
    protected FulcrumClusterApplicationContext applicationContext;
    ...
    public FulcrumClusterObjectStore(FulcrumClusterApplicationContext applicationContext) {
    ...
    public void setMuleContext(MuleContext muleContext) {
        ...
        if (appName == null) {
            ...
            store = applicationContext.distributedStore(appName + PARTITION_MAP_NAME + DEFAULT_PARTITION_NAME);
            partitionNameToDistributedStoreName = applicationContext.globalDistributedStore(appName + ALL_PARTITIONS_MAP_NAME);
        }
    }
    ...
    private synchronized ListableObjectStore<T> getPartitionMap(String partitionName) throws ObjectStoreException {
        ...
        return applicationContext.distributedStore(encodedPartitionName);
    }
